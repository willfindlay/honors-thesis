...
calls with base times of under 3\(\mu\)s from the \code{bronte-7day}
...
the \code{bronte-lmbench} dataset. Smaller difference in times is
...
from the \code{bronte-lmbench} dataset. Smaller difference in times is
better. Standard deviation is given as error bars.}
\end{figure}
