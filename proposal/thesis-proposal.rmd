...
executable, as well as a sparse two-dimensional away of lookahead pairs (TODO: point back
to lookahead pairs section in background) to keep track of system call sequences.
...
calls which comport with profile creation, association, and disassociation. These system calls
