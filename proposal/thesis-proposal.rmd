...
In order to monitor process behavior, ebpH maintains a unique
...
struct ebpH_profile
{
    ...
    u8 flags[SYSCALLS^2]; /* System call lookahead pairs */
    u64 key; /* Uniquely computed executable key */
    char comm[EBPH_FILENAME_LEN]; /* Name of the executable file */
};
\end{lstlisting}
