...
Linux Kernel, implemented as a loadable kernel module (LKM).

TODO: cite [@gregg18] here to talk about differences.
...
required between userland and the kernel is greatly diminished -- we can simply access the necessary data
as needed.
...
\lil[language=c, caption={Handling large data in eBPF programs.}, label={appendix-bigdata}]{../code/design_patterns/bigdata.c}
